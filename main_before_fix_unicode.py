...
class ExampleApp(QtGui.QMainWindow, design.Ui_MainWindow):
    ...
    def PopulateMetainformation(self):
        self.meta = metainfosketch.Process('root')    
        ...
        # Huvudprocess2
        l1[2].AddSubProcess('Underprocess(20)', 's')
        l1[2].AddSubProcess('Underprocess(21)', 's')
    ...
    # Usage: self.FindProcess(self.meta.GetSubProcesses())
    def IterateProcesses(self, pn):
    ...
    def test_unicode(self):
        ...
        print u'Testing Unicode...åäö', unicode(uni)
    ...
    def cmdOkTableViewClick(self):
        ...
        table = QtGui.QTableWidget(self.tableWidget)
        print self.m_table.item(1,1).text()
        ...
        if (self.foundProcess != None):
            ...
            for i in items:
                ...
                i.SetName(self.m_table.item(n,0).text())
                i.SetValue(self.m_table.item(n,1).text())
                i.SetComment(self.m_table.item(n,2).text())
                print 'Name', i.GetName()
                print 'Value', i.GetValue()
                print 'Comment', i.GetComment()
                n = n + 1
    ...
    def on_treeView_clicked(self, index):
        ...
        if (self.foundProcess != None):
            ...
            for i in items:
                ...
                self.m_table.setItem(n,0, QtGui.QTableWidgetItem(i.GetName()))
                self.m_table.setItem(n,1, QtGui.QTableWidgetItem(i.GetValue()))
                self.m_table.setItem(n,2, QtGui.QTableWidgetItem(i.GetComment()))
                n = n + 1
